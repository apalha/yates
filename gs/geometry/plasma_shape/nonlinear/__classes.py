...
class NonlinearShape():
    ...
    shape : string
        ...
        The codes identifying the different shapes are: ::
            "pataki_iter_0" : Small circle plasma shape corresponding to a large aspect ratio [pataki2013]_.
            "pataki_iter_1" : ITER like smooth plasma shape as presented in [pataki2013]_ (circle).
            "pataki_iter_2" : ITER like smooth plasma shape as presented in [pataki2013]_ (intermediate elongation).
            ...
            "palha_x_iter" : ITER like x-point plasma shape as presented in [palha2015]_.
    ...
    def generate_boundary(self,n):
        ...
        if self.shape == 'pataki_iter_2':
            self.r, self.z = pataki(self.n,0.00001,1.0,0.0)
        elif self.shape == 'pataki_iter_0':
            self.r, self.z = pataki(self.n,0.32,1.0,0.0)
        elif self.shape == 'pataki_iter_1':
            self.r, self.z = pataki(self.n,0.32,1.0,0.33)
        elif self.shape == 'pataki_iter':
            self.r, self.z = pataki(self.n,0.32,1.7,0.33)
        elif self.shape == 'pataki_nstx':
            self.r, self.z = pataki(self.n,0.78,2.0,0.35)
        elif self.shape == 'palha_x_iter':
            self.r, self.z = palha_x_iter(self.n)
